#!/bin/bash
# Simple Droplet Deployment for Full Network Peer Discovery
# Copy and paste this entire script into the droplet console

echo "🚀 Deploying Full Network Peer Discovery to Droplet"
echo "=================================================="
...
sudo cp src/consensus_service.py src/consensus_service.py.backup.$(date +%Y%m%d_%H%M%S)
echo "✅ Backup created"

# Step 2: Deploy enhanced consensus service
echo ""
echo "🔧 Step 2: Deploying enhanced consensus service with P2P discovery..."

# Create the enhanced consensus service file
sudo tee src/consensus_service.py > /dev/null << 'EOF'
"""
